...
export type GetEventMetaQuery = {
  __typename?: "Query";
  eventMeta?: { __typename?: "EventMeta"; id: string; type: string } | null;
};
...
export type DeleteGameMutation = {
  __typename?: "Mutation";
  deleteGame: { __typename?: "Game"; id: string; slug: string };
};
...
export type GetGamesQuery = {
  ...
  games: {
    ...
    nodes: Array<{
      ...
      status: string;
      _count?: { __typename?: "GameCounts"; events: number } | null;
    }>;
  };
};
...
export type GetGameActionsQuery = {
  __typename?: "Query";
  game?: {
    __typename?: "Game";
    id: string;
...
export type GetGameLayoutQuery = {
  __typename?: "Query";
  game?: {
    __typename?: "Game";
    id: string;
...
export type CheckGameSlugQuery = {
  __typename?: "Query";
  checkGameSlug: boolean;
};
...
export type CreateLeagueMutation = {
  ...
  createLeague: {
    ...
    event?: {
      ...
      registrationStartDate?: any | null;
      registrationEndDate?: any | null;
...
export type CheckEventSlugQuery = {
  __typename?: "Query";
...
export const GetEventMetaDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetEventMeta" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<GetEventMetaQuery, GetEventMetaQueryVariables>;
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "backgroundImagePath" },
                      },
                      {
                        kind: "Field",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetGameActions" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
...
} as unknown as DocumentNode<GetGameActionsQuery, GetGameActionsQueryVariables>;
export const GetGameLayoutDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetGameLayout" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
...
} as unknown as DocumentNode<GetGameLayoutQuery, GetGameLayoutQueryVariables>;
export const CheckGameSlugDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CheckGameSlug" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "excludeId" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
        },
      ],
...
} as unknown as DocumentNode<CheckGameSlugQuery, CheckGameSlugQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateLeagueEventInput" },
            },
          },
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateLeagueConfigInput" },
            },
          },
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "InitialStaffInput" },
              },
            },
          },
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "InitialEntryInput" },
              },
            },
          },
        },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "classificationSystem" },
                },
                { kind: "Field", name: { kind: "Name", value: "config" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "registrationStartDate" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "registrationEndDate" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "maxParticipants" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "requiresApproval" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "waitlistEnabled" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "officialLinks" },
                      },
                    ],
                  },
                },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "UpdateLeagueEventInput" },
          },
        },
        {
          kind: "VariableDefinition",
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "UpdateLeagueConfigInput" },
          },
        },
      ],
      selectionSet: {
...
>;
export const CheckEventSlugDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CheckEventSlug" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "excludeEventId" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
        },
      ],
...
} as unknown as DocumentNode<CheckEventSlugQuery, CheckEventSlugQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetLeagues" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "allowDraw" },
                      },
                      {
                        kind: "Field",
...
} as unknown as DocumentNode<GetLeaguesQuery, GetLeaguesQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "customFieldSchema" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "event" },
