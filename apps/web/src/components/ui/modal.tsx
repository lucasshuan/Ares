...
export function Modal({
  ...
  return createPortal(
    ...
    >
      <div
        className={cn(
          "glass-panel no-hover corner-round animate-modal-content bg-background-deep flex max-h-[95dvh] w-full flex-col overflow-hidden rounded-3xl will-change-[transform,opacity]",
          className,
        )}
      >
        {/* Header - Fixed */}
