...
export function Modal({
  ...
  return createPortal(
    ...
    >
      <div
        className={cn(
          "glass-panel no-hover corner-round animate-modal-content flex max-h-[95dvh] w-full flex-col overflow-hidden rounded-3xl bg-[#0a080f] will-change-[transform,opacity]",
          className,
        )}
      >
        {/* Header - Fixed */}
