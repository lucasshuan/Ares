...
interface EloLeagueAdminPanelProps {
  league: EloLeagueForPanel;
}

export function EloLeagueAdminPanel({ league }: EloLeagueAdminPanelProps) {
  ...
  return (
    <div className="mt-8 space-y-3">
      ...
      <EditLeagueModal
        league={{ ...league, type: "RANKED_LEAGUE" as const }}
        isOpen={isEditOpen}
