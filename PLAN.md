...
- [x] **3.1 Reestruturar Documentação**
  - [x] Atualizar o README principal com instruções claras de setup do monorepo e variáveis de ambiente e com foco em introduzir de forma sucinta do que se trata o projeto, tendo em vista que o repositório será público. Obs.: O objetivo não é que outros usuários entendam a arquitetura e rodem o projeto localmente, mas sim que tenham uma visão geral do projeto que visa ser open-source, e que sirva como ponto de partida para quem for contribuir ou usar o código como referência.
