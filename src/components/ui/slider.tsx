...
export function Slider({
  ...
  return (
    <div className={cn("relative flex w-full flex-col gap-2", className)}>
      <div className="relative h-6 w-full touch-none select-none items-center flex">
        {/* Track */}
        ...
        {/* Visible Thumb */}
        <div
          className="pointer-events-none absolute h-4 w-4 rounded-full border-2 border-primary bg-white shadow-lg transition-all duration-75"
